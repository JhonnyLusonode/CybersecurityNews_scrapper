...
try:
    ...
    for article in articles:
        ...
        link_element = article.find("a", class_="story-link")
    ...
    file_name = fr'C:\Users\Novo\Noticias\data\Hackernews_{current_date}.docx'
    doc.save(file_name)
    
    # Print the number of news added
    print(f"[Thehackernews] Número Total de Notícias novas: {news_count}")
